...
// =============================common============================
    ...
    public boolean tryLock(String key, long seconds, int maxRetryTime) {
        ...
        try {
            return redisTemplate.execute((RedisCallback<Boolean>) connection -> {
                ...
                Jackson2JsonRedisSerializer valueSerializer =
                        (Jackson2JsonRedisSerializer) redisTemplate.getValueSerializer();
            ...
            log.error("get lock error. key: " + key, e);
            return false;
        }
    }
    ...
    public long decr(String key, long time) {
        return decr(key, 1L, time);
    }
